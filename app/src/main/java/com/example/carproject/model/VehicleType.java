...
public enum VehicleType {
    COMPACT("COMPACT", "작고 회전이 빠름",  1.8f, 1.5f, 3.5f, 0.005f, 0.30f, new Color(1f, 1f, 0f, 1f)),
    SEDAN  ("SEDAN",   "표준 크기 및 밸런스", 2.0f, 1.4f, 4.5f, 0.004f, 0.35f, new Color(0f, 0.53f, 1f, 1f)),
    TRUCK  ("TRUCK",   "크고 조작이 어려움",  2.6f, 2.5f, 6.5f, 0.003f, 0.25f, new Color(1f, 0.2f, 0.2f, 1f));
